--4017980:超サイヤ人ゴッドSSベジット_ベジットソード
...
--味方側
SP_01 = 78970011; --カードカットインまで　前側
SP_02 = 78970012; --カードカットインまで　後ろ側
SP_03 = 78970013; --カードカットイン後　前側
SP_04 = 78970014; --カードカットイン後　後ろ側
...
SE15 = playSe( spep_2 + 240, 1141 );
setSeVolume( spep_2 + 240, 1141, 73 );
stopSe( spep_2 + 256, SE15, 0 );
...
stopSe( spep_2 + 276, SE17, 0 );

playSe( spep_2 + 265, 1031 );
setSeVolume( spep_2 + 265, 1031, 55 );

SE18 = playSe( spep_2 + 270, 1143 );
setSeVolume( spep_2 + 270, 1143, 55 );
stopSe( spep_2 + 286, SE18, 0 );
...
SE19 = playSe( spep_2 + 280, 1143 );
setSeVolume( spep_2 + 280, 1143, 73 );
stopSe( spep_2 + 296, SE19, 0 );
...
SE20 = playSe( spep_2 + 290, 1141 );
setSeVolume( spep_2 + 290, 1141, 73 );
stopSe( spep_2 + 306, SE20, 0 );
